(function() {
  ...
  exports.fetchSymbols = function() {
    return axios({
      url: 'https://api.energypriceapi.com/v1/symbols',
      params: {
        api_key: this.apiKey,
      },
    });
  ...
  exports.fetchLive = function(base, currencies) {
    return axios({
      url: 'https://api.energypriceapi.com/v1/latest',
      params: removeEmpty({
        api_key: this.apiKey,
        base: base,
  ...
  exports.fetchHistorical = function(date, base, currencies) {
    return axios({
      url: `https://api.energypriceapi.com/v1/${date}`,
      params: removeEmpty({
        api_key: this.apiKey,
        base: base,
        currencies: (currencies || []).join(','),
  ...
  exports.convert = function(from, to, amount, date) {
    return axios({
      url: 'https://api.energypriceapi.com/v1/convert',
      params: removeEmpty({
        api_key: this.apiKey,
        from: from,
        to: to,
  ...
  exports.timeframe = function(startDate, endDate, base, currencies) {
    return axios({
      url: 'https://api.energypriceapi.com/v1/timeframe',
      params: removeEmpty({
        api_key: this.apiKey,
  ...
  exports.change = function(startDate, endDate, base, currencies) {
    return axios({
      url: 'https://api.energypriceapi.com/v1/change',
      params: removeEmpty({
        api_key: this.apiKey,
        start_date: startDate,
        end_date: endDate,
